...
class PathUtil:
    ...
    @staticmethod
    def get_dirs(root_path: str) -> list:
        """
    ...
    @staticmethod
    def get_files(root_path: str, extension='*.*') -> list:
        """
    ...
    @staticmethod
    def get_dirname(root_path: str) -> str:
        """
    ...
    @staticmethod
    def create_dir(root_path: str, foldername: str) -> str:
        """
    ...
    @staticmethod
    def remove_dir(folder_path: str):
        """
